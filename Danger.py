...
FORWARD_CHANNEL_ID = -1002217623873
CHANNEL_ID = -1002217623873
error_channel_id = -1002217623873
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/+UyrFPUO-yAcyODk1")
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/c/2221841034/3614")
    button2 = types.InlineKeyboardButton(
